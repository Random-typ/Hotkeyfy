...
#pragma endregion
	private:
		String^ text;
		// used to unfocus the textbox
		Label^ invisibleLabel;
		double Value = 0;

		static System::Drawing::Pen^ arrowPen = gcnew System::Drawing::Pen(Colors::lightGrayBrush->Color, 2.4);
		static System::Drawing::Pen^ bodyPen = gcnew System::Drawing::Pen(Colors::highlightGrayBrush->Color);
	protected:
...
private: System::Void textBox1_KeyPress(System::Object^ sender, System::Windows::Forms::KeyPressEventArgs^ e) {
	...
	double value;
	if (!Double::TryParse(newInput, value) || value > 100)
	{
		e->Handled = true;
		System::Media::SystemSounds::Exclamation->Play();
	}
...
private: System::Void textBox1_TextChanged(System::Object^ sender, System::EventArgs^ e) {
	...
	{
		int value;
		if (Int32::TryParse(textBox1->Text, value) || value <= 100)
		{
			Value = value;
		}
	}
	...
	{
		double value;
		if (Double::TryParse(textBox1->Text, value) || value <= 100.0)
		{
			Value = value;
		}
	}
